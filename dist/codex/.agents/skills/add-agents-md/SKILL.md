---
name: add-agents-md
description: "[ADD v0.10.2] Generate or sync a portable AGENTS.md from ADD project state — writes, checks drift, or merges with hand-curated content"
argument-hint: "[--write|--check|--merge|--import] [--dry-run]"
---

# ADD AGENTS.md Skill v0.10.2
