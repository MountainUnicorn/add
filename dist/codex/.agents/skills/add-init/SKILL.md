---
name: add-init
description: "[ADD v0.9.1] Initialize Agent Driven Development — PRD interview + project setup"
...
If NOT detected, use ask the user (use a clear, single-question prompt):
