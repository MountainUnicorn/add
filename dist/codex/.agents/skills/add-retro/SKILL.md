---
name: add-retro
description: "[ADD v0.10.0] Run a retrospective — context-aware, data-driven review with pre-populated tables"
...
5. Check for session handoff — per the Session-Handoff Preflight in `~/.codex/add/references/skill-epilogue.md`
