...
When a dispatching skill (`/add-cycle`, `/add-tdd-cycle`) fills in the MODEL field of a sub-agent brief, use these defaults — aligned with the Resource Budgets policy in `~/.codex/add/references/swarm-protocol.md`:
