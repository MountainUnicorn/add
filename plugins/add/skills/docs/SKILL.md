---
description: "[ADD v0.10.1] Generate and sync project documentation — architecture diagrams, API docs, README"
...
3. **Read knowledge tiers** — filter for relevance
   - Tier 1: `${CLAUDE_PLUGIN_ROOT}/knowledge/global.md` — universal ADD best practices
