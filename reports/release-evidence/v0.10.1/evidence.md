...
|---|---|
| core/VERSION | 0.10.1 |
| plugins/add plugin.json | 0.10.1 |
| .add/config.json (dogfood) | 0.10.1 |
| Codex CLI pin (CI target) | 0.144.5 |
| Codex CLI minimum supported | 0.122.0 |

## Migration-chain coverage

UNBROKEN — 25 hops; every listed version reaches 0.10.1

## Install smoke (latest main runs)

- https://github.com/MountainUnicorn/add/actions/runs/29658501467 — success (install-smoke-claude.yml)
- https://github.com/MountainUnicorn/add/actions/runs/29658501459 — success (install-smoke-codex.yml)
