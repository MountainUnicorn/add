...
|---|---|
| core/VERSION | 0.11.0 |
| plugins/add plugin.json | 0.11.0 |
| .add/config.json (dogfood) | 0.11.0 |
| Codex CLI pin (CI target) | 0.144.5 |
| Codex CLI minimum supported | 0.140.0 |

## Migration-chain coverage

UNBROKEN — 27 hops; every listed version reaches 0.11.0

## Install smoke (latest main runs)

- https://github.com/MountainUnicorn/add/actions/runs/29704538791 — success (install-smoke-claude.yml)
- https://github.com/MountainUnicorn/add/actions/runs/29704538784 — success (install-smoke-codex.yml)
