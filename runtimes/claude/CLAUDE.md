...
├── rules/             # Auto-loading behavioral rules ({{RULE_COUNT}} files), injected per-maturity at SessionStart
...
On-demand rules (`autoload: false` — loaded via skill `references:` when needed): {{ONDEMAND_RULES}}
